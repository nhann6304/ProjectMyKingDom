...
import {
    ...
    CardIcon,
    TruckLive,
} from "@/app/assets/common/icon-public/svg/icon/iconItem";
import logo from "@/app/assets/common/icon-public/jpg/logo-254x76 (1).png";
import vietnam from "@/app/assets/common/icon-public/jpg/co-nuoc-anh.svg.png";
import anhquoc from "@/app/assets/common/icon-public/jpg/co-viet-nam.svg.png";
import { FaChevronDown, FaChevronUp } from "react-icons/fa";
import { IoMdArrowDropright } from "react-icons/io";
import { IoMenu } from "react-icons/io5";
import DropdownNav from "@/app/components/dropdown/DropdownNav";
interface IOption {
    content: string;
